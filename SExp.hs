...
data SExp a = Atom {getAtom :: a} | SList {getSList :: [SExp a]} deriving (Eq, Ord, Functor, Foldable, Traversable)
...
s = SList [Atom 1, Atom 2, SList [Atom 3, SList [Atom 4]], Atom 5] :: SExp Int
